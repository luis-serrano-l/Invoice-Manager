...
%Product{name: "Potato", price: 2.0, stock: 3000, company_id: 1}
|> Repo.insert!()

%Product{name: "Apple", price: 1.0, stock: 5000, company_id: 1}
|> Repo.insert!()

%Product{name: "Banana", price: 0.5, stock: 6000, company_id: 1}
|> Repo.insert!()

%Product{name: "Milk", price: 3.0, stock: 2000, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Chicken", price: 5.0, stock: 1000, company_id: 1}
|> Repo.insert!()

%Product{name: "Beef", price: 7.0, stock: 800, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Carrot", price: 1.0, stock: 4000, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Cheese", price: 4.0, stock: 1800, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Salmon", price: 8.0, stock: 1000, company_id: 1}
|> Repo.insert!()

%Product{name: "Shrimp", price: 10.0, stock: 700, company_id: 1}
|> Repo.insert!()

%Product{name: "Tuna", price: 5.5, stock: 1200, company_id: 1}
|> Repo.insert!()

%Product{name: "Bacon", price: 6.0, stock: 900, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Water", price: 1.0, stock: 5000, company_id: 1}
|> Repo.insert!()

%Product{name: "Beer", price: 5.0, stock: 1400, company_id: 1}
|> Repo.insert!()

%Product{name: "Wine", price: 12.0, stock: 600, company_id: 1}
|> Repo.insert!()

%Product{name: "Whiskey", price: 20.0, stock: 300, company_id: 1}
|> Repo.insert!()

%Product{name: "Vodka", price: 15.0, stock: 400, company_id: 1}
|> Repo.insert!()

%Product{name: "Tequila", price: 18.0, stock: 350, company_id: 1}
|> Repo.insert!()

%Product{name: "Rum", price: 10.0, stock: 550, company_id: 1}
|> Repo.insert!()

%Product{name: "Tea", price: 3.0, stock: 2500, company_id: 1}
|> Repo.insert!()

%Product{name: "Coffee", price: 5.0, stock: 2000, company_id: 1}
|> Repo.insert!()

%Product{name: "Sugar", price: 1.5, stock: 3800, company_id: 1}
|> Repo.insert!()

%Product{name: "Flour", price: 2.0, stock: 3200, company_id: 1}
|> Repo.insert!()

%Product{name: "Salt", price: 1.0, stock: 4500, company_id: 1}
|> Repo.insert!()

%Product{name: "Pepper", price: 1.25, stock: 4200, company_id: 1}
|> Repo.insert!()

%Product{name: "Olive Oil", price: 6.0, stock: 1600, company_id: 1}
|> Repo.insert!()

%Product{name: "Vinegar", price: 3.5, stock: 2200, company_id: 1}
|> Repo.insert!()

%Product{name: "Ketchup", price: 2.0, stock: 2800, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Pickles", price: 3.0, stock: 2100, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Canned Vegetables", price: 2.5, stock: 3000, company_id: 1}
|> Repo.insert!()

%Product{name: "Peanut Butter", price: 4.5, stock: 1900, company_id: 1}
|> Repo.insert!()

%Product{name: "Jelly", price: 3.5, stock: 2200, company_id: 1}
|> Repo.insert!()
...
%Product{name: "Instant Noodles", price: 1.5, stock: 4800, company_id: 1}
|> Repo.insert!()

%Product{name: "Frozen Vegetables", price: 2.25, stock: 3300, company_id: 1}
|> Repo.insert!()

%Product{name: "Frozen Pizza", price: 5.5, stock: 2100, company_id: 1}
|> Repo.insert!()

%Product{name: "Frozen Dinners", price: 4.5, stock: 2400, company_id: 1}
|> Repo.insert!()

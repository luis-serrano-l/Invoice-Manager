defmodule InvoiceManagerWeb.CoreComponents do
  @moduledoc """
  ...
  import InvoiceManagerWeb.Gettext
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-1 space-y-3 bg-white">
        <%= render_slot(@inner_block, f) %>
        <div :for={action <- @actions} class="mt-2 px-4 flex items-center justify-between gap-6">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InvoiceManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InvoiceManagerWeb.Gettext, "errors", msg, opts)
    end
  end
